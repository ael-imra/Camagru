  ...
  $_SESSION["script"] = "<script>display_signup();</script>";
    if(isset($_SESSION["csrfToken"]) && $_SESSION["csrfToken"] == $_POST["csrfToken"])
    {
        if(isset($_POST["Username"],$_POST["Email"],$_POST["Password"],$_POST["Confirm_Password"]) && $_POST["Username"]!= "" && $_POST["Email"] != "" && $_POST["Password"] != "" && $_POST["Confirm_Password"]==$_POST["Password"])
        {
            ...
            {
                if(!validator_Username($_POST["Username"]))
                    set_message_failed("Username must be :<br/>-between 7 and 25 character",$url);
                else if(!validator_Email($_POST["Email"]))
                    set_message_failed("Email wrong.",$url);
                else if(!validator_Password($_POST["Password"]))
                    set_message_failed("Password wrong.",$url);
                else
                {
    ...
    if(isset($_SESSION["csrfToken"]) && $_SESSION["csrfToken"] == $_POST["csrfToken"])
    {
        if($_POST["Email"] != "")
        {
            ...
            if ($data)
            {
                ...
                $stmt->execute();
                send_mail($Tokenpassword, $_POST["Email"],"reset Password",$_POST["csrfToken"]);
                set_message_success("To Reset Your Password Please check your Email",$url);
            }
            else
                set_message_failed("This Email does not exist.",$url);
        }
    }
    else
        set_message_failed("Wrong CSRF TOKEN",$url);
...
<body style="height:100vh;">
  <div class="d-flex flex-column m-0 p-0 h-100">
    <nav class="navbar navbar-expand-sm" id="first-menu">
      <div class="mx-auto">
    ...
    <section class="d-flex flex-row position-relative h-100">
      <div class="login-register d-flex flex-row w-75 br-box border-dark overflow-hidden mt-4 mx-auto">
        ...
        <div class="w-100 d-flex flex-column justify-content-around mx-auto" style="max-width: 520px">
          <div class="ml-auto switch border rounded-pill border-white mt-4 mr-2">
          ...
          <div class="d-flex signup align-items-center h-100">
            <div class="d-flex flex-column align-items-center w-100">
              <h2>Regitration</h2>
              <form class="w-100" action="login.php" method="post">
                <input type="hidden" name="csrfToken" value="<?php echo $csrfToken?>">
                <div class="form-group mx-auto mt-4 w-75">
                  <input class="rounded-pill w-100" type="Email" name="Email" placeholder="Email" required>
                </div>
                <div class="form-group mx-auto mt-4 w-75">
                  <input class="rounded-pill w-100" type="text" name="Username" placeholder="Username" required>
                </div>
                <div class="form-group mx-auto mt-4 w-75">
                ...
                <div class="form-group mx-auto mt-5 w-100 text-center">
          ...
          <div class="d-flex signin align-items-center  h-100">
            <div class="d-flex flex-column align-items-center w-100">
              ...
              <form class="w-100" action="login.php" method="post">
                ...
                <div class="form-group mx-auto mt-1 w-100 text-right mr-2">
                ...
                <div class="form-group mx-auto mt-3 w-75">
                  <input class="rounded-pill w-100" id="btn-signin" type="submit" name="signin" value="Sign in">
                </div>
              </form>
            </div>
          </div>
          <div class="d-flex reset_password align-items-center h-100">
            <div class="d-flex flex-column align-items-center w-100">
              ...
              <form class="w-100" action="login.php" method="post">
                <input type="hidden" name="csrfToken" value="<?php echo $csrfToken?>">
                <div class="form-group mx-auto mt-4 mb-4 w-75">
                  <input class="rounded-pill w-100" type="Email" name="Email" placeholder="Email" required>
                </div>
                <div class="form-group mx-auto mt-5 w-75">
                  <input class="rounded-pill w-100" id="btn-reset_Password" type="submit" name="reset_Password"
                    value="Reset Password">
                </div>
                <div class="form-group mx-auto mt-3 w-75">
                  <p class="rounded-pill text-center w-100" style="cursor: pointer" id="btn-back"
